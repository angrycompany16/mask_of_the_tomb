...
func CreateScene1(cmd *commands.Commands) *engine.Scene {
	...
	scene.SpawnActor("particleSystem",
		particles.NewParticleSystem(
			...
			maths.RandomFloat{-1, 1},
			maths.RandomFloat{-100, 100},
			maths.RandomFloat{-30, 30},
			maths.RandomFloat{-40, 10},
			maths.RandomFloat{0, 0},
			maths.RandomFloat{0, 0},
			maths.RandomFloat{0, 0},
			maths.RandomFloat{0.1, 0.25},
			maths.RandomFloat{0.0, 0.0},
			maths.RandomFloat{1.0, 3.0},
			maths.RandomFloat{0, 0},
			maths.RandomFloat{0, 0},
			[4]uint8{255, 255, 255, 255},
